...
src_prepare() {
    ...
    sed \
        ...
        -e "s|@GUILE_SEED_FILE_I686@|${GUILE_SEED_FILE_I686}|g" \
        -e "s|@GUILE_SEED_HASH_I686@|${GUILE_SEED_HASH_I686}|g" \
        -e "s|@GUILE_SEED_FILE_X86_64@|${GUILE_SEED_FILE_X86_64}|g" \
        -e "s|@GUILE_SEED_HASH_X86_64@|${GUILE_SEED_HASH_X86_64}|g" \
